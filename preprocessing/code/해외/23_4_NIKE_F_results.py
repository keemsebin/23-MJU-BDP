# 파일에서 데이터를 읽어오기
with open('/content/drive/MyDrive/Colab Notebooks/BDP/23_4_NIKE_F.txt', 'r') as f:
    lines = f.readlines()
...
# 결과를 파일에 저장
with open('/content/drive/MyDrive/Colab Notebooks/BDP/23_4_NIKE_F_new.txt', 'w') as f:
    for result in price_results_processed:
