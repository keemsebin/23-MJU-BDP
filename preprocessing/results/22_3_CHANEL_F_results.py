...
for line in filtered_data:
    ...
    if match:
        result = round(1342.41 * float(match.group(1)), 2)
...
for line in pound_lines:
    ...
    if match_front:
        result = round(1579.27 * float(match_front.group(1)), 2)
        results.append(result)
    elif match_back:
        result = round(1579.27 * float(match_back.group(2)), 2)
        results.append(result)
...
for line in dollar_lines:
    ...
    if match_front:
        result = round(1342.41 * float(match_front.group(1)), 2)
        results.append(result)
    elif match_back:
        result = round(1342.41 * float(match_back.group(2)), 2)
        results.append(result)
...
for line in euro_lines:
    ...
    if match_front:
        result = round(1351.36 * float(match_front.group(1)), 2)
        results.append(result)
    elif match_back:
        result = round(1351.36 * float(match_back.group(2)), 2)
        results.append(result)
