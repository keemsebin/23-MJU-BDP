...
# 파일에서 데이터를 읽어오기
with open('/content/drive/MyDrive/Colab Notebooks/BDP/23_2_NIKE.txt', 'r') as f:
    lines = f.readlines()
...
# 결과를 파일에 저장하기
with open('/content/drive/MyDrive/Colab Notebooks/BDP/23_2_NIKE_results.txt', 'w') as f:
    for result in results:
        f.write(result + '\n')